...
function begin() {
    ...
    switch (random) {
        case "speakAndSpell": 
            ...
            document.getElementById("backgroundImg").src = 'assets/images/SpeakAndSpell.jpg';
            break;
        case "aBrokenFrame":
            document.getElementById("hint").innerHTML = "A Broken Frame";
            document.getElementById("backgroundImg").src = 'assets/images/ABrokenFrame.jpg';
            break;
        case "constructionTimeAgain":
            document.getElementById("hint").innerHTML = "Construction Time Again";
            document.getElementById("backgroundImg").src = 'assets/images/ConstructionTimeAgain.png';
            break;
        case "someGreatReward":
            document.getElementById("hint").innerHTML = "Some Great Reward";
            document.getElementById("backgroundImg").src = 'assets/images/SomeGreatReward.png';
            break;
        case "blackCelebration":
            document.getElementById("hint").innerHTML = "Black Celebration";
            document.getElementById("backgroundImg").src = 'assets/images/BlackCelebration.png';
            break;
        case "musicForTheMasses":
            document.getElementById("hint").innerHTML = "Music for the Masses";
            document.getElementById("backgroundImg").src = 'assets/images/MFTM.png';
            break;
        case "violator":
            document.getElementById("hint").innerHTML = "Violator";
            document.getElementById("backgroundImg").src = 'assets/images/Violator.png';
            break;
        case "songsOfFaithAndDevotion":
            document.getElementById("hint").innerHTML = "Songs of Faith and Devotion";
            document.getElementById("backgroundImg").src = 'assets/images/SOFAD.png';
            break;
        case "ultra":
            document.getElementById("hint").innerHTML = "Ultra";
            document.getElementById("backgroundImg").src = 'assets/images/Ultra.png';
            break;
        case "exciter":
            document.getElementById("hint").innerHTML = "Exciter";
            document.getElementById("backgroundImg").src = 'assets/images/Exciter.png';
            break;
        case "playingTheAngel":
            document.getElementById("hint").innerHTML = "Playing the Angel";
            document.getElementById("backgroundImg").src = 'assets/images/PTA.png';
            break;
        case "soundsOfTheUniverse":
            document.getElementById("hint").innerHTML = "Sounds of the Universe";
            document.getElementById("backgroundImg").src = 'assets/images/SOTU.png';
            break;
        case "deltaMachine":
            document.getElementById("hint").innerHTML = "Delta Machine";
            document.getElementById("backgroundImg").src = 'assets/images/DeltaMachine.png';
            break;
        case "spirit":    
            document.getElementById("hint").innerHTML = "Spirit";
            document.getElementById("backgroundImg").src = 'assets/images/Spirit.png';
            break;
        default:
            document.getElementById("hint").innerHTML = "Depeche Mode Song";
            document.getElementById("backgroundImg").src = 'assets/images/DMlogo.jpg';
...
function gameOverLoss() {
    ...
    for (var i = 0; i < picked.length; i++) {
            ...
            dashes[i] = "<li style='color:#222'>" + picked.charAt(i) + "</li>";
        }
    }
    document.getElementById("word").innerHTML = dashes.join("");
    game = false;
...
function startNewGame() {
    ...
    document.getElementById("newGameButton").addEventListener("click", begin);
